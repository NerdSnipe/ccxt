...
func  (this *CoincatchCore) CalculateRateLimiterCost(api interface{}, method interface{}, path interface{}, params interface{}, optionalArgs ...interface{}) interface{}  {
 ...
 */
func  (this *CoincatchCore) FetchTime(optionalArgs ...interface{}) <- chan interface{} {
 ...
 */
func  (this *CoincatchCore) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *CoincatchCore) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            ch <- this.ParseDepositWithdrawFees(data, codes, "coinName")
            return nil
        
            }()
            return ch
        }
func  (this *CoincatchCore) ParseDepositWithdrawFee(fee interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // {
    //     "coinId":"1",
    //     "coinName":"BTC",
 ...
 */
func  (this *CoincatchCore) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            if IsTrue(IsEqual(this.SafeList(this.Options, "currencyIdsListForParseMarket"), nil)) {
                ...
                retRes77612 := (<-this.FetchCurrencies())
...
func  (this *CoincatchCore) ParseMarket(market interface{}) interface{}  {
    //
    // spot
    //     {
    //         "symbol": "BTCUSDT",
...
func  (this *CoincatchCore) ParseSpotMarketId(marketId interface{}) interface{}  {
...
func  (this *CoincatchCore) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // spot
    //     {
    //         "symbol": "BTCUSDT",
 ...
 */
func  (this *CoincatchCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *CoincatchCore) ParseOHLCV(ohlcv interface{}, optionalArgs ...interface{}) interface{}  {
    market := GetArg(optionalArgs, 0, nil)
    _ = market
...
func  (this *CoincatchCore) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // fetchTrades spot
    //     {
    //         "symbol": "ETHUSDT_SPBL",
...
func  (this *CoincatchCore) ParseFundingRate(contract interface{}, optionalArgs ...interface{}) interface{}  {
    market := GetArg(optionalArgs, 0, nil)
    _ = market
...
func  (this *CoincatchCore) HandleOptionParamsAndRequest(params interface{}, methodName interface{}, optionName interface{}, request interface{}, requestProperty interface{}, optionalArgs ...interface{}) interface{}  {
...
func  (this *CoincatchCore) ParseBalance(balances interface{}) interface{}  {
    //
    // spot
    //     [
    //         {
...
func  (this *CoincatchCore) ParseTransfer(transfer interface{}, optionalArgs ...interface{}) interface{}  {
    currency := GetArg(optionalArgs, 0, nil)
    _ = currency
...
func  (this *CoincatchCore) ParseDepositAddress(depositAddress interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "coin": "USDT",
    //         "address": "TKTUt7qiTaMgnTwZXjE3ZBkPB6LKhLPJyZ",
...
func  (this *CoincatchCore) ParseTransaction(transaction interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // fetchDeposits
    //
    //     {
...
func  (this *CoincatchCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "createMarketBuyOrderRequiresPrice", false)
                ...
                retRes230615 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func  (this *CoincatchCore) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(market, "spot")) {
                    ...
                    retRes233619 :=  (<-this.CreateSpotOrder(symbol, typeVar, side, amount, price, params))
                    PanicOnError(retRes233619)
                    ch <- retRes233619
                    return nil
            } else if IsTrue(GetValue(market, "swap")) {
        
                    retRes233819 :=  (<-this.CreateSwapOrder(symbol, typeVar, side, amount, price, params))
                    PanicOnError(retRes233819)
                    ch <- retRes233819
                    return nil
            } else {
...
func  (this *CoincatchCore) CreateSpotOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    /**
    * @method
    * @ignore
...
func  (this *CoincatchCore) HandleRequiresPriceAndCost(methodName interface{}, optionalArgs ...interface{}) interface{}  {
    params := GetArg(optionalArgs, 0, map[string]interface{} {})
    _ = params
...
func  (this *CoincatchCore) HandleTimeInForceAndPostOnly(methodName interface{}, optionalArgs ...interface{}) interface{}  {
    params := GetArg(optionalArgs, 0, map[string]interface{} {})
    _ = params
...
func  (this *CoincatchCore) CreateSwapOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    /**
    * @method
    * @ignore
    ...
    */
    ...
    if IsTrue((!IsEqual(endpointType, "tpsl"))) {
        ...
        var sideIsExchangeSpecific interface{} = false
        ...
        if !IsTrue(sideIsExchangeSpecific) {
            ...
            if IsTrue(hedged) {
                if IsTrue(IsTrue((!IsEqual(reduceOnly, nil))) && IsTrue(reduceOnly)) {
...
func  (this *CoincatchCore) HandleTriggerStopLossAndTakeProfit(symbol interface{}, side interface{}, typeVar interface{}, price interface{}, optionalArgs ...interface{}) interface{}  {
...
func  (this *CoincatchCore) EncodeTimeInForce(timeInForce interface{}) interface{}  {
...
func  (this *CoincatchCore) CreateOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    price := GetArg(optionalArgs, 0, nil)
    _ = price
    params := GetArg(optionalArgs, 1, map[string]interface{} {})
    _ = params
...
func  (this *CoincatchCore) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(market, "spot")) {
                    ...
                    retRes292819 :=  (<-this.EditSpotOrder(id, symbol, typeVar, side, amount, price, params))
...
func  (this *CoincatchCore) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(marketType, "spot")) {
                    ...
                    retRes317119 :=  (<-this.FetchOpenSpotOrders(symbol, since, limit, params))
                    PanicOnError(retRes317119)
                    ch <- retRes317119
                    return nil
            } else if IsTrue(IsEqual(marketType, "swap")) {
        
                    retRes317319 :=  (<-this.FetchOpenSwapOrders(symbol, since, limit, params))
...
func  (this *CoincatchCore) FetchOpenSpotOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes31958 := (<-this.LoadMarkets())
            PanicOnError(retRes31958)
...
func  (this *CoincatchCore) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(marketType, "spot")) {
                    ...
                    retRes344419 :=  (<-this.FetchCanceledAndClosedSpotOrders(symbol, since, limit, params))
                    PanicOnError(retRes344419)
                    ch <- retRes344419
                    return nil
            } else if IsTrue(IsEqual(marketType, "swap")) {
        
                    retRes344619 :=  (<-this.FetchCanceledAndClosedSwapOrders(symbol, since, limit, params))
 ...
 */
func  (this *CoincatchCore) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            retRes38428 := (<-this.LoadMarkets())
            PanicOnError(retRes38428)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *CoincatchCore) GetResultFromBatchCancelingSwapOrders(response interface{}) interface{}  {
    var data interface{} = this.SafeDict(response, "data", map[string]interface{} {})
...
func  (this *CoincatchCore) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // createOrder spot
    //     {
    //         "orderId": "1217143186968068096",
...
func  (this *CoincatchCore) ParseOrderStatus(status interface{}) interface{}  {
...
func  (this *CoincatchCore) ParseOrderSide(side interface{}) interface{}  {
...
func  (this *CoincatchCore) ParseOrderTimeInForce(timeInForce interface{}) interface{}  {
...
func  (this *CoincatchCore) ParseFeeDetailString(feeDetailString interface{}) interface{}  {
    var result interface{} = []interface{}{}
 ...
 */
func  (this *CoincatchCore) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *CoincatchCore) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes449915 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes449915)
                ch <- retRes449915
                return nil
...
func  (this *CoincatchCore) ParseMarginMode(marginMode interface{}, optionalArgs ...interface{}) interface{}  {
    market := GetArg(optionalArgs, 0, nil)
    _ = market
...
func  (this *CoincatchCore) ParseMarginModeType(typeVar interface{}) interface{}  {
 ...
 * @returns {object} response from the exchange
 */
func  (this *CoincatchCore) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            retRes45838 := (<-this.LoadMarkets())
            PanicOnError(retRes45838)
            var market interface{} = this.Market(symbol)
...
func  (this *CoincatchCore) EncodeMarginModeType(typeVar interface{}) interface{}  {
    var types interface{} = map[string]interface{} {
        "cross": "crossed",
        "isolated": "fixed",
    }
 ...
 */
func  (this *CoincatchCore) FetchPositionMode(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 * @returns {object} response from the exchange
 */
func  (this *CoincatchCore) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            retRes46658 := (<-this.LoadMarkets())
            PanicOnError(retRes46658)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes469515 :=  (<-this.PrivatePostApiMixV1AccountSetPositionMode(this.Extend(request, params)))
                PanicOnError(retRes469515)
                    //
            //     {
            //         "code": "00000",
            //         "msg": "success",
 ...
 * @returns {object} response from the exchange
 */
func  (this *CoincatchCore) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *CoincatchCore) ParseLeverage(leverage interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // fetchLeverage
    //     {
    //         "marginCoin": "ETH",
...
func  (this *CoincatchCore) ModifyMarginHelper(symbol interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *CoincatchCore) ParseMarginModification(data interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //
    market := GetArg(optionalArgs, 0, nil)
    _ = market
...
func  (this *CoincatchCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "methodName", "reduceMargin")
                ...
                retRes489215 :=  (<-this.ModifyMarginHelper(symbol, OpNeg(amount), "reduce", params))
                PanicOnError(retRes489215)
                ch <- retRes489215
                return nil
...
func  (this *CoincatchCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "methodName", "addMargin")
                ...
                retRes490815 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
                PanicOnError(retRes490815)
                ch <- retRes490815
                return nil
...
func  (this *CoincatchCore) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes50048 := (<-this.LoadMarkets())
            PanicOnError(retRes50048)
            var productType interface{} = "umcbl"
...
func  (this *CoincatchCore) ParsePosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "marginCoin": "USDT",
    //         "symbol": "ETHUSDT_UMCBL",
...
func  (this *CoincatchCore) SafeMarketCustom(marketId interface{}, optionalArgs ...interface{}) interface{}  {
    // catch block:
...
func  (this *CoincatchCore) ParseLedgerEntry(item interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // spot
    //     {
    //         "billId": "1220289012519190529",
...
func  (this *CoincatchCore) ParseLedgerEntryType(typeVar interface{}) interface{}  {
    var types interface{} = map[string]interface{} {
        "deposit": "deposit",
        "withdraw": "withdrawal",
        "buy": "trade",
...
func  (this *CoincatchCore) HandleErrors(code interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    if !IsTrue(response) {
...
func  (this *CoincatchCore) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
