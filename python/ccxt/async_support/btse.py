...
class btse(Exchange, ImplicitAPI):
    ...
    async def fetch_ticker(self, symbol: str, params={}):
        ...
        response = None
        if market['spot']:
            response = await self.publicSpotGetApiV32MarketSummary(self.extend(request, params))
        else:
            response = await self.publicGetApiV23MarketSummary(self.extend(request, params))
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}):
        ...
        response = None
        if market['spot']:
            response = await self.publicSpotGetApiV32OrderbookL2(self.extend(request, params))
        else:
            response = await self.publicGetApiV23Orderbook(self.extend(request, params))
    ...
    async def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}):
        ...
        response = None
        if market['spot']:
            response = await self.publicSpotGetApiV32Trades(self.extend(request, params))
        else:
            response = await self.publicGetApiV23Trades(self.extend(request, params))
    ...
    async def fetch_ohlcv(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params={}):
        ...
        response = None
        if market['spot']:
            response = await self.publicSpotGetApiV32Ohlcv(self.extend(request, params))
        else:
            response = await self.publicGetApiV23Ohlcv(self.extend(request, params))
    ...
    async def fetch_balance(self, params={}) -> Balances:
        ...
        response = await self.privateGetApiV23UserWallet(self.extend(request, params))
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: float = None, params={}) -> Order:
        ...
        response = await self.privatePostApiV23Order(self.extend(request, params))
    ...
    async def cancel_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        if clientOrderId is not None:
            ...
            request['orderID'] = id
        response = await self.privateDeleteApiV23Order(self.extend(request, params))
    ...
    async def edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: float = None, price: float = None, params={}) -> Order:
        ...
        response = await self.privatePutApiV23Order(self.extend(request, params))
        return self.parse_order(response, market)
    ...
    async def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        response = await self.privateGetApiV23UserOpenOrders(self.extend(request, params))
    ...
    async def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        response = await self.privateGetApiV23UserTradeHistory(self.extend(request, params))
        return self.parse_trades(response, market, since, limit)
    ...
    async def fetch_positions(self, symbols: List[str] = None, params={}):
        ...
        """
        await self.load_markets()
        response = await self.privateGetApiV23UserPositions(params)
        result = []
    ...
    async def set_leverage(self, leverage: float, symbol: Str = None, params={}):
        ...
        response = await self.privatePostApiV23Leverage(self.extend(request, params))
        return response
    ...
    async def transfer(self, code: str, amount: float, fromAccount: str, toAccount: str, params={}) -> TransferEntry:
        ...
        response = await self.privatePostApiV23UserWalletTransfer(self.extend(request, params))
