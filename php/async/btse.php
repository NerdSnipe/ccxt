...
class btse extends Exchange {
    ...
    public function fetch_ticker(string $symbol, $params = array ()) {
        return Async\async(function () use ($symbol, $params) {
            ...
            $response = null;
            if ($market['spot']) {
                $response = Async\await($this->publicSpotGetApiV32MarketSummary ($this->extend($request, $params)));
            } else {
                $response = Async\await($this->publicGetApiV23MarketSummary ($this->extend($request, $params)));
            }
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            $response = null;
            if ($market['spot']) {
                $response = Async\await($this->publicSpotGetApiV32OrderbookL2 ($this->extend($request, $params)));
            } else {
                $response = Async\await($this->publicGetApiV23Orderbook ($this->extend($request, $params)));
            }
    ...
    public function fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = null;
            if ($market['spot']) {
                $response = Async\await($this->publicSpotGetApiV32Trades ($this->extend($request, $params)));
            } else {
                $response = Async\await($this->publicGetApiV23Trades ($this->extend($request, $params)));
            }
    ...
    public function fetch_ohlcv(string $symbol, $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $timeframe, $since, $limit, $params) {
            ...
            $response = null;
            if ($market['spot']) {
                $response = Async\await($this->publicSpotGetApiV32Ohlcv ($this->extend($request, $params)));
            } else {
                $response = Async\await($this->publicGetApiV23Ohlcv ($this->extend($request, $params)));
            }
    ...
    public function fetch_balance($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->privateGetApiV23UserWallet ($this->extend($request, $params)));
    ...
    public function create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $type, $side, $amount, $price, $params) {
            ...
            $response = Async\await($this->privatePostApiV23Order ($this->extend($request, $params)));
    ...
    public function cancel_order(string $id, ?string $symbol = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $response = Async\await($this->privateDeleteApiV23Order ($this->extend($request, $params)));
    ...
    public function edit_order(string $id, string $symbol, string $type, string $side, ?float $amount = null, ?float $price = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($id, $symbol, $type, $side, $amount, $price, $params) {
            ...
            $response = Async\await($this->privatePutApiV23Order ($this->extend($request, $params)));
            return $this->parse_order($response, $market);
        }) ();
    }
    ...
    public function fetch_open_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->privateGetApiV23UserOpenOrders ($this->extend($request, $params)));
    ...
    public function fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->privateGetApiV23UserTradeHistory ($this->extend($request, $params)));
            return $this->parse_trades($response, $market, $since, $limit);
        }) ();
    }
    ...
    public function fetch_positions(?array $symbols = null, $params = array ()) {
        return Async\async(function () use ($symbols, $params) {
             ...
             */
            Async\await($this->load_markets());
            $response = Async\await($this->privateGetApiV23UserPositions ($params));
            $result = array();
    ...
    public function set_leverage(float $leverage, ?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($leverage, $symbol, $params) {
            ...
            $response = Async\await($this->privatePostApiV23Leverage ($this->extend($request, $params)));
            return $response;
        }) ();
    }
    ...
    public function transfer(string $code, float $amount, string $fromAccount, string $toAccount, $params = array ()): PromiseInterface {
        return Async\async(function () use ($code, $amount, $fromAccount, $toAccount, $params) {
            ...
            $response = Async\await($this->privatePostApiV23UserWalletTransfer ($this->extend($request, $params)));
